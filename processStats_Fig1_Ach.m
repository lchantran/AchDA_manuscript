...
swappedChannelMice={...  % which mice should have the channels swapped?
    'S766', 'WT58', 'WT60', 'WT61', 'WT53', 'WT54', 'WT55', 'WT56'...
    };
...
conditionSets={};
% conditionSets{end+1}={'NoLed/LED Rew' 'theseSessions' 'trials'    {'Rew', 'SI', [0 18], 'processed_WT62_11222021'}   {'Rew', 'SI', [0 18], 'processed_WT62_11082021'}};
% conditionSets{end+1}={'NoLed/LED Rew' 'theseSessions' 'trials'    {'Rew', 'SI', [0 18], 'processed_WT63_11222021'}   {'Rew', 'SI', [0 18], 'processed_WT63_11102021'}};
% conditionSets{end+1}={'NoLed/LED Rew' 'theseSessions' 'trials'    {'Rew', 'SI', [0 18], 'processed_WT64_11222021'}   {'Rew', 'SI', [0 18], 'processed_WT64_11082021'}};
% conditionSets{end+1}={'NoLed/LED Rew' 'theseSessions' 'trials'    {'Rew', 'SI', [0 18], 'processed_WT65_11222021'}   {'Rew', 'SI', [0 18], 'processed_WT65_11082021'}};
% conditionSets{end+1}={'NoLed/LED NoRew' 'theseSessions' 'trials'    {'NoRew', 'SI', [0 10], 'processed_WT62_11222021'}   {'NoRew', 'SI', [0 10], 'processed_WT62_11082021'}};
% conditionSets{end+1}={'NoLed/LED NoRew' 'theseSessions' 'trials'    {'NoRew', 'SI', [0 10], 'processed_WT63_11222021'}   {'NoRew', 'SI', [0 10], 'processed_WT63_11102021'}};
% conditionSets{end+1}={'NoLed/LED NoRew' 'theseSessions' 'trials'    {'NoRew', 'SI', [0 10], 'processed_WT64_11222021'}   {'NoRew', 'SI', [0 10], 'processed_WT64_11082021'}};
% conditionSets{end+1}={'NoLed/LED NoRew' 'theseSessions' 'trials'    {'NoRew', 'SI', [0 10], 'processed_WT65_11222021'}   {'NoRew', 'SI', [0 10], 'processed_WT65_11082021'}};
