...
conditionSets={};
conditionSets{end+1}={'NoLed/LED Rew' 'theseSessions' 'trials'    {'Rew', 'SI', [0 rewN], 'processed_WT58_10042021'}   {'Rew', 'SI', [0 rewN], 'processed_WT58_10182021'}};
conditionSets{end+1}={'NoLed/LED Rew' 'theseSessions' 'trials'    {'Rew', 'SI', [0 rewN], 'processed_WT59_10042021'}   {'Rew', 'SI', [0 rewN], 'processed_WT59_10182021'}};
conditionSets{end+1}={'NoLed/LED Rew' 'theseSessions' 'trials'    {'Rew', 'SI', [0 rewN], 'processed_WT60_10042021'}   {'Rew', 'SI', [0 rewN], 'processed_WT60_10182021'}};
conditionSets{end+1}={'NoLed/LED Rew' 'theseSessions' 'trials'    {'Rew', 'SI', [0 rewN], 'processed_WT61_10042021'}   {'Rew', 'SI', [0 rewN], 'processed_WT61_10182021'}};
conditionSets{end+1}={'NoLed/LED NoRew' 'theseSessions' 'trials'    {'NoRew', 'SI', [0 norewN], 'processed_WT58_10042021'}   {'NoRew', 'SI', [0 norewN], 'processed_WT58_10182021'}};
conditionSets{end+1}={'NoLed/LED NoRew' 'theseSessions' 'trials'    {'NoRew', 'SI', [0 norewN], 'processed_WT59_10042021'}   {'NoRew', 'SI', [0 norewN], 'processed_WT59_10182021'}};
conditionSets{end+1}={'NoLed/LED NoRew' 'theseSessions' 'trials'    {'NoRew', 'SI', [0 norewN], 'processed_WT60_10042021'}   {'NoRew', 'SI', [0 norewN], 'processed_WT60_10182021'}};
conditionSets{end+1}={'NoLed/LED NoRew' 'theseSessions' 'trials'    {'NoRew', 'SI', [0 norewN], 'processed_WT61_10042021'}   {'NoRew', 'SI', [0 norewN], 'processed_WT61_10182021'}};

% 
% % %ipsi vs contra no reward
% %conditionSets{end+1}={'r/l' 'all' 'trials'                  {'w_r', 'SI', [0 norewN]}   {'w_l', 'SI', [0 norewN]}};
% conditionSets{end+1}={'r/l' 'mouse' 'trials'                {'w_r', 'SI', [0 norewN]}   {'w_l', 'SI', [0 norewN]}};
% %conditionSets{end+1}={'r/l(Pre)' 'all' 'trials'             {'w_r', 'SI', [preN 0]}   {'w_l', 'SI', [preN 0]}};
% conditionSets{end+1}={'r/l(Pre)' 'mouse' 'trials'           {'w_r', 'SI', [preN 0]}   {'w_l', 'SI', [preN 0]}};
% 
% % ipsi vs contra reward
% %conditionSets{end+1}={'R/L' 'all' 'trials'                  {'w_R', 'SI', [0 rewN]}   {'w_L', 'SI', [0 rewN]}};
% conditionSets{end+1}={'R/L' 'mouse' 'trials'                {'w_R', 'SI', [0 rewN]}   {'w_L', 'SI', [0 rewN]}};
% %conditionSets{end+1}={'R/L(Pre)' 'all' 'trials'             {'w_R', 'SI', [preN 0]}   {'w_L', 'SI', [preN 0]}};
% conditionSets{end+1}={'R/L(Pre)' 'mouse' 'trials'           {'w_R', 'SI', [preN 0]}   {'w_L', 'SI', [preN 0]}};
% 
...
% conditionSets{end+1}={'dupAb/ab' 'mouse' 'trials'              {'w_Ab', 'SI', [0 norewN]}  {'w_ab', 'SI', [0 norewN]}}; % done
% %conditionSets{end+1}={'Ab/ab(Pre)' 'all' 'trials'           {'w_Ab', 'SI', [preN 0]}  {'w_ab', 'SI', [preN 0]}};
% conditionSets{end+1}={'dupAb/ab(Pre)' 'mouse' 'trials'         {'w_Ab', 'SI', [preN 0]}  {'w_ab', 'SI', [preN 0]}}; % done
% 
% % Aa vs aa
            ...
            if numel(mergedAllData)>0
                ...
                for randCounter=1:2
                    ...
                    for momentCounter=1:4
                        ...
                        statsTable.(['moment' mString '_dp_avg'])(tableCounter)=mean(momentsDP(:,momentCounter));
                    end
                end
            end
        end
