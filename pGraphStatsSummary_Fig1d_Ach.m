...
load('statsAndMore Figure1_Ach.mat')

%% plot dprime and stats

dPrimePlotColumns={'mean','LDA_testPred_dp'}; %'mean_c12_dp', 'var', 'LDA_testPred_dp'};%, 'MSE_train_cond1_dp', 'MSE_train_cond2_dp'};
dPrimeLabels={'mean ', 'LDA', 'dMean', 'var ',  'LDA ', 'MSE1', 'MSE2'};

miceToPlot={};
conditionsToPlot=[2:2:12];
...
maxVal=10; % put a cap on the value to keep the y-scale the same
