...
conditionSets{end+1}={'(pre aX)Sw/NoSw' 'mouse' 'trials'           {'FNoRewSw', 'SI', [preN startDrop]}   {'FNoRewNoSw', 'SI', [preN startDrop]}}; % done
conditionSets{end+1}={'(pre AX)Sw/NoSw' 'mouse' 'trials'           {'FRewSw', 'SI', [preN startDrop]}   {'FRewNoSw', 'SI', [preN startDrop]}}; % done
