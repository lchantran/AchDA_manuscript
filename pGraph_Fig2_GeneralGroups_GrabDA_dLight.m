...
combosToPlot={... % {'label', {condition1, channel1, metric1, group1}, {condition2, channel2, metric2, group2}}
    {'DA post max Rew', {1, 1, 'max', 1 }, {1, 6, 'max', 1}}...
    {'DA post min NoRew', {1, 1, 'min', 2}, {1, 6, 'min', 2}}...
    {'DA pre max All', {1, 1, 'max', 1}, {1, 6, 'max', 1}}...
    };
% 
% combosToPlot={... % {'label', {condition1, channel1, metric1, group1}, {condition2, channel2, metric2, group2}}
%     {'DA Rew UnRew', {1, 6, 'mean', 1}, {1, 6, 'mean', 2}}...
%     {'DA aA AA', {2, 6, 'mean', 1 }, {2, 6, 'mean', 2}}...
%     {'DA aa Aa', {3, 6, 'mean', 1 }, {3, 6, 'mean', 2}}...
%     {'DA aB AB', {4, 6, 'mean', 1 }, {4, 6, 'mean', 2}}...
%     {'DA ab Ab', {5, 6, 'mean', 1 }, {5, 6, 'mean', 2}}...
%     };
