...
conditionSets{end+1}={'All(Pre)' 'mouse' 'trials'     {'All', 'SI', [preN -startDrop]}   {'All', 'SI', [preN -startDrop]}}; % done
% 
% % % % are reward and no reward different before and after the SI
