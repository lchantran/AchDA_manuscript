...
%load('statsAndMore Figure1_DA_Fig1_LR_RewNoRew_TestAll.mat')

%% plot dprime and stats

dPrimePlotColumns={'mean_cond1_avg', 'mean_cond2_avg', 'max_cond1_avg', 'max_cond2_avg', 'min_cond1_avg', 'min_cond2_avg' };% 'MSE_train_cond1_dp', 'MSE_train_cond2_dp'};
dPrimeLabels={'mean1', 'mean2', 'max1', 'max2', 'min1', 'min2'};
