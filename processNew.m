                        ...
                        if length(output)>10000 % then continue.  Otherwise, what is this?
                            ...
                            if is9ChanData
                                params.channelDefs={...
                                    ...
                                    'Rightport', ...            % Ch 8
                                    'Leftport', ...             % Ch 9
                                    'Left Lick', ...            % Ch 10 %these will all be zero values
                                    'Right Lick', ...           % Ch 11 %these will all be zero values
                                    'Left LED', ...             % Ch 13 %these will all be zero values
                                    'Laser' ...                 % Ch 14 %these will all be zero values
                                    };
                            elseif is13ChanData
                                params.channelDefs={...
                                    'AIN0', ...                 % Ch 1
